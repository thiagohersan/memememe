package me.memememe.opencvhaartest;
...
public class HaarTestActivity extends AppCompatActivity implements CvCameraViewListener2 {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_haar_test);

        mOpenCvCameraView = (CameraBridgeViewBase) findViewById(R.id.haar_test_activity_surface_view);
